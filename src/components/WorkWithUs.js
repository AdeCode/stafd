...
function WorkWithUs() {
    return (
        <section className='bg-flash_white text-smoky_black lg:pt-16 pt-7 pb-20 lg:pb-0 min-h-screen relative'>
            <h2 className='font-bold lg:text-4xl lg:text-left text-center text-2xl lg:ml-16 lg:mb-12 mb-6'>
                Why work with us?
            </h2>
            <div className='px-16 grid lg:grid-cols-3 grid-cols-1 gap-8 lg:gap-28'>
                <div className='flex items-center flex-col'>
                    <FontAwesomeIcon icon={faFilter} size="6x" className='mb-5'/>
                    <h3 className='font-semibold lg:text-2xl text-lg mb-3'>
                ...
                <div className='flex items-center flex-col'>
                    <FontAwesomeIcon icon={faHandshake} size="6x" className='mb-5' />
                    <h3 className='font-semibold lg:text-2xl text-lg mb-3'>
                        Tailored Talent Solutions
                    </h3>
                    <p className='text-center text-base'>
                ...
                <div className='flex items-center flex-col'>
                    <FontAwesomeIcon icon={faArrowsSpin} size="6x" className='mb-5'/>
                    <h3 className='font-semibold lg:text-2xl text-lg mb-3'>
                        Tailored Talent Solutions
                    </h3>
                    <p className='text-center text-base'>
