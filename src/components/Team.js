...
function Team() {
  return (
    <section className='bg-smoky_black min-h-screen lg:pl-16 pl-4 py-5 lg:py-0 pt-24 lg:pt-0 flex items-center' id="team">
        <div className='flex lg:flex-row flex-col lg:items-center items-start lg:gap-[200px] gap-5'>
            ...
            <div className='relative group'>
                ...
                text-center lg:opacity-0 lg:group-hover:opacity-100 transition duration-1000 ease-in-out'>
